...
# my solution, partially correct I was able to create the getter/setter moethods but had trouble converting to the fixed array to array obect and calling the to_s on the fixed object.
